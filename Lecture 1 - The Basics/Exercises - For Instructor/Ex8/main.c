...
uint16_t hmmm = 0xA5C5;
// original = "SomePasswordThatIsImpossibleToReverseHashBecauseItIsTooLongAlsoILikeCrabs"
unsigned char pwd[16] = {0x69, 0xb4, 0xf3, 0x02, 0x97, 0x53, 0x02, 0x50, 0x95, 0x4c, 0x82, 0x5d, 0x50, 0x3e, 0xfa, 0x18};
